...
int Maquina()
{
  ...
  if (EscolhaMaquina == 5)
  {
    printf("Máquina escolhe Spock\n");
  }
  else if (EscolhaMaquina == 4)
  {
    printf("Máquina escolhe Lagarto\n");
  }
  else if (EscolhaMaquina == 3)
  {
    printf("Máquina escolhe Pedra\n");
  }
  else if (EscolhaMaquina == 2)
  {
        printf("Máquina escolhe Papel\n");
  }
  else if (EscolhaMaquina == 1)
  {
    printf("Máquina escolhe Tesoura\n");
  }
